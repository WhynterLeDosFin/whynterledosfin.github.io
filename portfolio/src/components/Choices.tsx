...
const Choices: React.FC = () => {
    ...
    useEffect(() => {
        ...
        el.style.transition = "max-height 600ms ease, opacity 450ms ease";
    ...
    const handleClick = (tech: Tech) => {
        if (selectedTech?.id === tech.id) {
            ...
            if (mountedTech?.id === tech.id) {
                closeThen(() => setMountedTech(null));
            }
            return;
        }
    ...
    return (
        <div className={styles.choices}>
                    ...
                    {techs.map((tech) => (
                        <rect
                            ...
                            className={`${styles.gradientRect} ${
                                mountedTech?.id === tech.id ? styles.visible : ""
                            }`}
                        />
                    ))}
                </svg>
            ...
            >
                {mountedTech ? (
                    <>
                        <h1>{mountedTech.name}</h1>
                        <h3>Présentation</h3>
                        <p>{mountedTech.presentation}</p>
                        <h3>Pourquoi ?</h3>
                        <p>{mountedTech.why}</p>
                    </>
                ) : null}
